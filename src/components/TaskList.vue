...
<template>
  <div class="toast toast-bottom toast-center">
    ...
    >
      ...
      <div class="ms-3 text-sm font-normal itbkk-message">The task {{ taskInsert }} is added successfully.</div>
      <button
        type="button"
    ...
    >
      ...
      <div class="ms-3 text-sm font-normal itbkk-message">Task has been deleted.</div>
      <button
