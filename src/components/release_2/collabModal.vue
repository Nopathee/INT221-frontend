            ...
            <div class="grid gap-4 mb-4">
              ...
              <div class="col-span-2 itbkk-access-right">
                <label for="accessRight" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Access Right</label>
                    <select id="accessRight" v-model="newAccess" class="dropdown bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 itbkk-access-rihgt">
