...
const formatterCreateOn = computed(() => {
  const createOn = new Date(props.task.createdOn).toLocaleString('en-GB')
  return `${createOn}`;
});

const formatterUpdatedOn = computed(() => {
  const updateOn = new Date(props.task.updatedOn).toLocaleString('en-GB')
  return `${updateOn}`;
});


// const formatterCreateOn = new Date(props.task.createdOn).toLocaleString('en-GB')
// const formatterUpdatedOn = new Date(props.task.updatedOn).toLocaleString('en-GB')
