        ...
        <div class="fixed inset-0 flex items-center justify-center z-50">
            <div class="bg-white rounded-lg p-8 max-w-md shadow-2xl dark:bg-gray-700">
                ...
                <form class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            ...
                            <input id="taskTitle" type="text" v-model.trim="task.title" maxlength="100"
                        ...
                        <div class="row-span-10">
                            ...
                            <textarea id="taskDescription" type="text" v-model.trim="task.description" maxlength="500"
                        ...
                        <div class="row-span-8">
                            ...
                            <textarea id="taskAssignees" type="text" v-model.trim="task.assignees" maxlength="30"
                ...
                <div class="flex justify-end">
                    <button @click="$emit('saveTask', task)"
